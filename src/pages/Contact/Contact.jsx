...
export const Contact = () => {
  ...
  return (
    <Page header="Contact">
      <ContactWrapper>
        <ContactForm
          action="https://formspree.io/f/xpwwerjl"
          method="POST"
          name="contact"
          id="contactform"
        >
        ...
        <div className="buttons">
          <div className="socials">
            <a
              href="https://www.linkedin.com/in/divakargwork/"
              target="_blank"
            ...
            <a href="mailto:divakarg.work@gamil.com">
              <IconButton bg={green}>
            ...
            <a
              href="https://github.com/Divakar-G-Github"
              target="_blank"
              rel="noopener noreferrer"
            >
